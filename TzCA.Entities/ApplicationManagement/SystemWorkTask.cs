...
namespace TzCA.Entities.ApplicationOrganization
{
    ...
    /// </summary>
    public class SystemWorkTask :EntityBase, IEntity
    {
        [StringLength(100)]
        ...
        [StringLength(150)]
        public string BussinessCode { get; set; }                   // 任务业务编码
        [StringLength(100)]
        ...
        public bool HasShortCutLinkItem { get; set; }          // 是否使用快捷链接方式
        public bool HasTileLinkItem { get; set; }              // 是否使用入口瓷砖方式

        public SystemWorkTask()
        {
            this.Id = Guid.NewGuid();
            this.IconName = "";
            this.IsForMeOnly = false;
            this.IsForMyDepartmentOnly = false;
            this.IsForDefaultSystemRoleGroup = false;
            this.IsUsedInMenu = true;
            this.HasShortCutLinkItem = false;
            this.HasTileLinkItem = false;
        }
    }
}
