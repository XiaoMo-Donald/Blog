layui.use(['form', 'layer', 'laydate', 'table', 'laytpl'], function () {
    ...
    var tableIns = table.render({
        ...
        cols: [[
            ...
            { field: 'name', title: '文章标题', width: 350, align: 'center' },
            { field: 'abstract', title: '文章摘要', width: 350, align: 'center' },
    ...
    //添加文章页面
    function addBlogArticle(edit) {
        var index = layui.layer.open({
            title: "添加文章",
            type: 2,
            content: "../../Admin/AddBlogArticle",
    ...
    $(".addBlogArticle_btn").click(function () {
        addBlogArticle();
    })
