(function() {
    ...
    layui.use(['laydate', 'laypage', 'layer', 'table', 'form', 'carousel', 'upload', 'element'], function() {
        ...
        table.render({
            ...
            url: 'http://127.0.0.1:8020/云盟项目前端实施/Index/MockData/userOrderData.json', //数据接口                
            page: true, //开启分页                
            cols: [
                [ //表头
                    { fixed: true, checkbox: true, unresize: true }, //开启复选框        
                    { field: 'orderNumber', fixed: 'left', title: '序号', width: 80, align: 'center', sort: true, unresize: true },
        ...
        $('#demoReloadQuery').on('click', function() {
