 ...
 * 1.使用方法：
 *      1.1.必须的引用：
 *          CSS:  -- jQuery-emoji-master/lib/css/jquery.mCustomScrollbar.min.css
                  -- jQuery-emoji-master/dist/css/jquery.emoji.css
            JS:   -- jQuery-emoji-master/lib/script/highlight.pack.js
                  -- jQuery-emoji-master/lib/script/jquery.mCustomScrollbar.min.js
                  -- jQuery-emoji-master/dist/js/jquery.emoji.min.js
                  -- jQuery-emoji-master/lib/script/tzJQueryEmoji.js
        1.2.初始化： 
                  -- tzEmoji.init(option)
        1.3.转换：
...
var tzEmoji = {
    init: function (option) {
        ...
        $($option.textarea).emoji({
            ...
            icons: [{
                name: "经典表情",
                path: $option.iconPath + "jQuery-emoji-master/dist/img/tieba/",
                maxNum: 50,
                file: ".jpg",
                placeholder: ":{alias}:",
                alias: {
                ...
                name: '动态表情',
                path: $option.iconPath + "jQuery-emoji-master/dist/img/qq/",
                maxNum: 91,
                ...
                name: "emoji高清",
                path: $option.iconPath + "jQuery-emoji-master/dist/img/emoji/",
                maxNum: 84,
                file: ".png",
    ...
    reSetForArticleReply: function () {
        ...
        setTimeout(function () {          
            _$emoji_btn = $(".commentReplyItemFormArea>.emoji_btn");
            _$emoji_container = $(".commentReplyItemFormArea>.emoji_container");
