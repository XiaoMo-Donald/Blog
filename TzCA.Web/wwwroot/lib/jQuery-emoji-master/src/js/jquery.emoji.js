    ...
    Plugin.prototype = {
        _init: function () {
            ...
            if (!btn) {
                ...
                //$(newBtn).appendTo($('body')); //ԭʼ
                this.$content.parent().parent().before(newBtn);
                //$('#emoji_btn_' + ix).css({ 'top': contentTop + 'px', 'left': contentLeft + 'px' }); //ԭʼ
                $('#emoji_btn_' + ix).css({ 'bottom': '10px', 'left': '0px', 'z-index': 4 });
                btn = '#emoji_btn_' + ix;
            }
            ...
            //$(emoji_container).appendTo($('body')); //ԭʼ
            this.$content.parent().parent().before(emoji_container);
            ...
            //$('#emoji_container_' + ix).css({ 'top': panelTop + 'px', 'left': panelLeft + 'px' }); //ԭʼ
            $('#emoji_container_' + ix).css({ 'bottom': '40px', 'left': '0px', 'z-index': 4 });
